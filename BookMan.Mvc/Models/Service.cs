    ...
    public class Service
    {
        ...
        public Service()
        {
            if (!File.Exists(_dataFile))
            {
                ...
                {
                    new Book{Id = 1, Name = "ASP.NET Core for dummy", Authors= "Trump D.", Publisher= "Washington", Year = 2019},
                    new Book{Id = 2, Name = "Pro ASP.NET Core", Authors= "Putin V.", Publisher= "Moscow", Year = 2019},
